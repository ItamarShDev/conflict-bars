...
export function convertConvexEventToTimeline(event: ConvexEvent): EventsTimeline {
  return {
    time: {
      start: event.start,
      end: event.end,
...
export function convertConvexEventsToTimeline(events: ConvexEvent[]): EventsTimeline[] {
