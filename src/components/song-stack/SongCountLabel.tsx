...
function getSongCountText(lang: 'en' | 'he', songCount: number, songsLabel: string): string {
    if (lang === 'he') {
        if (songCount === 1) {
            return 'שיר אחד';
        }
...
export function SongCountLabel({ lang, songCount, songsLabel }: SongCountLabelProps) {
    return (
