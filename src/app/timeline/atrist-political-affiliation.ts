export const artistPoliticalAffiliation = {
  ...
  "Subliminal": {
    ...
    "notes": "Prominent after 2nd Intifada, pro-IDF, patriotic lyrics, clashes with leftist rappers."
  },
  "The Shadow (HaTzel)": {
    "era": "2000s–present",
  ...
  "Tuna": {
    ...
    "notes": "Lyrics touch on inequality, frustration with politics, but avoids clear partisan stance."
  },
  "Peled": {
    "era": "2000s–present",
    "affiliation": "Center-left / Critical",
    "notes": "Mix of satire and social commentary, often mocks political establishment."
  },
  "Nechi Nech": {
    "era": "2010s–present",
    "affiliation": "Center-left / Social critique",
    "notes": "Touches on discrimination, everyday struggles, less explicitly partisan."
  },
  "Jimbo J": {
    "era": "2010s–present",
    "affiliation": "Left-leaning",
    "notes": "Known for sharp storytelling, social critique, and satire of Israeli politics."
  },
  "Cohen@Mushon": {
    "era": "2000s–2010s",
    "affiliation": "Liberal / Apolitical humor",
    "notes": "Mostly playful, but generally aligned with Tel Aviv left-liberal scene."
  },
  "Strong Black Coffee (Kafe Shachor Chazak)": {
    "era": "2010s–present",
    "affiliation": "Social justice",
    "notes": "Focus on Ethiopian-Israeli struggles, systemic racism, police brutality."
  },
  "Echo": {
    "era": "2010s–present",
  ...
  "Mooki (מוקי)": {
    ...
    "notes": "Former frontman of Shabak Samech; solo work often emphasizes social themes, justice, and calls for peace rather than partisan politics."
  },

  "DAM": {
    "era": "1990s–present",
    "affiliation": "Palestinian left / Anti-occupation / Social justice",
    "notes": "Pioneering Palestinian hip hop group from Lod; lyrics address occupation, inequality, and identity; known for activist stance and collaborations."
  },
