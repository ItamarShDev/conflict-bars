...
export const tuna2010s: TimelineEvent[] = [
  {
    timestamp: '2010–2019',
    conflict: {
      title: 'Breakout decade and mainstream presence',
      reason: 'Tuna gained mainstream visibility with solo work and collaborations as Israeli hip‑hop diversified.'
    },
    songs: [
      // 2015 — Gam Zeh Ya'avor (גם זה יעבור)
      {
        ...
        links: {
          ...
          youtube: 'https://www.youtube.com/watch?v=H9zO1oXHWRY'
        }
      },
      {
      ...
      // 2019 — Ve'Achshav La'Helek Ha'Intergalakti
      {
