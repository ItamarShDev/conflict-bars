...
export const subliminal2000s: TimelineEvent[] = [
  {
    timestamp: "2000-2005",
    conflict: {
      title: 'The Second Intifada (Al-Aqsa Intifada)',
      reason: 'A brutal period of widespread Palestinian suicide bombings and Israeli military operations. This era polarized society and profoundly shaped Israeli hip-hop, leading to the rise of defiant, patriotic \'Zionist rap\' on one side, and protest music critical of the government and occupation on the other.',
    },
    songs: [
      {
  ...
  },
  {
    timestamp: "2006-2009",
    conflict: {
      title: 'Post-Intifada, Lebanon War & Gaza Operations',
      reason: 'This period included the trauma of the 2006 Second Lebanon War and the 2008-09 Operation Cast Lead in Gaza. The music reflects a sense of weariness with the cycle of violence, a critique of leadership, and a desire for escapism.',
    },
    songs: [
      {
