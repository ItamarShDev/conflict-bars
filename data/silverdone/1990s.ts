...
export const silverdone1990s: SongList = [
	{
		...
		published_date: "1999",
		lyric_sample: {
				hebrew: "המדינה בסכנה, הכל מתפרק, הפיגועים לא מפסיקים, אנחנו חוזרים לבית",
				english_translation: "The state is in danger, everything is falling apart, the attacks don't stop, we return home",
		},
		links: {
