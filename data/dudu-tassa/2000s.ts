...
export const duduTassa2000s: SongList = [
	{
		...
		lyric_sample: {
			hebrew:
				"קיום משותף, זה הדרך שלנו / קיום משותף, זה העתיד שלנו",
			english_translation:
	...
	{
		name: "Cultural Bridge (גשר תרבות)",
		artist: "Dudu Tassa (דודו טסה)",
		language: "Hebrew/Arabic",
		published_date: "2007",
		lyric_sample: {
			hebrew:
				"גשר תרבות, זה מה שאנחנו בונים / גשר תרבות, זה מה שאנחנו שרים",
			english_translation:
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"ערבית והברית, שתי שפות אחת / ערבית והברית, שתי תרבויות אחת",
			english_translation:
