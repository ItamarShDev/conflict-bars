...
export const hadagNahash2010s = [
	{
		...
		lyric_sample: {
			hebrew:
				"כתב־אישום נגד הפוליטיקה הישראלית, ביקורת חריפה על מערכת הממשל",
			english_translation:
	...
	},
	{
		...
		artist: "Hadag Nahash (הדג נחש)",
		collaborators: ["Tazmoret Hamahapecha (תזמורת המהפכה)"],
		language: "Hebrew",
		published_date: "2013",
		lyric_sample: {
			hebrew:
				"פרודיה–מחאה על ציונות ומיתוסים לאומיים, ביקורת על הנרטיב הלאומי",
			english_translation:
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"טקסט ישיר על המדינה כשטח אש, תקציבים לביטחון",
			english_translation:
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"ירושלים כאיקון של קדושה/אלימות/עוני–עושר; עיר תחת מתח מתמיד",
			english_translation:
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"גרסת 2004 הפכה לאבן־דרך של מחאה; ב־2019 יצאה הקלטה מחודשת",
			english_translation:
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"מבט ציני על מיתוג ודימוי המדינה בחו״ל",
			english_translation:
