...
export const theShadow2000s: SongList = [
	...
	},
	{
		...
		lyric_sample: {
			hebrew:
				"אמא אדמה שלי, לא שלי כל מה שהיה שלי, אפילו המדינה שלי, סכנה שלי, הפכה להיות שק חבטות.",
			english_translation:
...

	{
		...
		lyric_sample: {
			hebrew:
				"כיבוי אורות הצל נכנס מילים צלילים צרות, צרות צרורות האל קרס טילים נופלים גבולות.",
			english_translation:
