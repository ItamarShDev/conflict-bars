...
export const subliminal2000s: SongList = [
	{
		...
		lyric_sample: {
			hebrew:
				"אני ראיתי כמה הם הלכו, יותר מדי מהם לא חזרו... התקווה בראשנו, אהבה בנפשנו.",
			english_translation:
				"I saw how many went, too many did not return... The hope is in our minds, love in our souls.",
		},
		links: {
	...
	},
	{
		...
		lyric_sample: {
			...
			english_translation:
				"Here in the land stood the fathers who were promised\nEvery land was promised and the land was hurtful",
		},
		links: {
