...
export const alNather2010s = [
	{
		...
		collaborators: ["Shabjdeed (شبجديد)"],
		language: "Arabic",
		published_date: "2019",
		lyric_sample: {
			hebrew:
				"עם ביטים טראפ סטקטו, שיר על התנגדות פלסטינית, נכלל ברשימת 'שירי ההיפ-הופ הגדולים בכל הזמנים' של ה-BBC",
			english_translation:
	...
	},
	{
		name: "Inn Ann",
		artist: "Al Nather (النثر)",
		collaborators: ["Shabjdeed (شبجديد)", "Daboor (دابور)"],
		language: "Arabic",
		published_date: "2021",
		lyric_sample: {
			hebrew:
				"אנתם פלסטיני בלתי רשמי לנוער פלסטיני, קול של דור צעיר בהתנגדות",
			english_translation:
